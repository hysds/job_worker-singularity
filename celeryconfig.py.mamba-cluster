...
### BROKER_URL = "amqp://ops:StayAtTheAria@hfe1:5672//"
### BROKER_URL = "amqp://guest:guest@hfe1:5672//"
...
### CELERY_RESULT_BACKEND = "redis://:StayAtTheAria@hfe1:6379"
CELERY_RESULT_BACKEND = "redis://:NDIyZWFmNWQ2MjZjMTg1OGYzMjBkMjVh@tpfe2.nas.nasa.gov:6379"
...
### REDIS_JOB_STATUS_URL = "redis://:StayAtTheAria@hfe1:6379"
...
ROOT_WORK_DIR = "/nobackupp12/lpan/work/1/"
WEBDAV_URL = None
WEBDAV_PORT = 8085
